 ...
 % ATURAN
 % -- Predikat pertanyaan/1 untuk menanyakan pertanyaan terkait gejal  X.
...
% -- Predikat diagnosa/1 digunakan untuk menanyakan dan menyimpan
% Staatus gejala X.
diagnosa(G) :-
    pertanyaan(G),
    writeln(" (y/t)"),
...
% -- Predikat gejala/1 dipanggil untuk memerika status gejala dari
% database,
